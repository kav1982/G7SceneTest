...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class UniversalRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent uiRenderScaleText = EditorGUIUtility.TrTextContent("UIRender Scale", "UI渲染的单独缩放值，实现只对游戏相机进行降分辨率而UI不降");
        ...
        SerializedProperty m_UIRenderScale;
        ...
        void OnEnable()
        {
            ...
            m_UIRenderScale = serializedObject.FindProperty("m_UIRenderScale");
        ...
        void DrawQualitySettings()
        {
            ...
            if (m_QualitySettingsFoldout.value)
            {
                ...
                m_UIRenderScale.floatValue = EditorGUILayout.Slider(Styles.uiRenderScaleText, m_UIRenderScale.floatValue, m_RenderScale.floatValue, UniversalRenderPipeline.maxRenderScale);
                EditorGUI.indentLevel--;
                EditorGUILayout.Space();
                EditorGUILayout.Space();
            }
