                ...
                if (hdr)
                {
                    ...
                    switch (tonemapping.mode.value)
                    {
                        ...
                        case TonemappingMode.UE4_ACES:
                            ...
                            material.SetFloat(ShaderConstants._FilmSlope, tonemapping.filmicSlope.value);
                            material.SetFloat(ShaderConstants._FilmToe, tonemapping.filmicToe.value);
                            material.SetFloat(ShaderConstants._FilmShoulder, tonemapping.filmicShoulder.value);
                            material.SetFloat(ShaderConstants._FilmBlackClip, tonemapping.filmicBlackClip.value);
                            material.SetFloat(ShaderConstants._FilmWhiteClip, tonemapping.filmicWhiteClip.value);
                            break;
