...
namespace UnityEngine.Rendering.Universal
{
    public sealed partial class UniversalRenderPipeline : RenderPipeline
    {
        ...
        public static bool gameCameraShow = true;
        ...
        public UniversalRenderPipeline(UniversalRenderPipelineAsset asset)
        {
            ...
            Shader.DisableKeyword(ShaderKeywordStrings.EDITOR_BLUR);
        }
...
#pragma warning restore 0618
        ...
        static void InitializeCameraData(Camera camera, UniversalAdditionalCameraData additionalCameraData, bool resolveFinalTarget, out CameraData cameraData)
        {
            ...
            cameraData.cameraTargetDescriptor = CreateRenderTextureDescriptor(camera, Mathf.Max(cameraData.renderScale, cameraData.uiRenderScale),
                cameraData.isHdrEnabled, msaaSamples, needsAlphaChannel, cameraData.requiresOpaqueTexture);
            cameraData.gameCameraTargetDescriptor = CreateRenderTextureDescriptor(camera, cameraData.renderScale,
                cameraData.isHdrEnabled, msaaSamples, needsAlphaChannel, cameraData.requiresOpaqueTexture);
            // UI的Alpha遮罩需要有Alpha
            cameraData.uiCameraTargetDescriptor = CreateRenderTextureDescriptor(camera, cameraData.uiRenderScale,
                cameraData.isHdrEnabled, msaaSamples, true, cameraData.requiresOpaqueTexture);
        }
        ...
        static void InitializeStackedCameraData(Camera baseCamera, UniversalAdditionalCameraData baseAdditionalCameraData, ref CameraData cameraData)
        {
            ...
            cameraData.renderScale = (Mathf.Abs(1.0f - rs) < kRenderScaleThreshold) ? 1.0f : rs;
            rs = settings.uiRenderScale;
            cameraData.uiRenderScale = (Mathf.Abs(1.0f - rs) < kRenderScaleThreshold) ? 1.0f : rs;
        ...
        static void InitializeAdditionalCameraData(Camera camera, UniversalAdditionalCameraData additionalCameraData, bool resolveFinalTarget, ref CameraData cameraData)
        {
            ...
            cameraData.isUICamera = camera.CompareTag("UICamera");
            cameraData.isGameMainCamera = camera.CompareTag("MainCamera");
            ...
            bool anyPostProcessingEnabled, out RenderingData renderingData)
        {
            ...
            renderingData.skipAllPass = gameCameraShow == false && cameraData.isGameMainCamera;
            renderingData.postProcessingSetMat = new Queue<Action<Material>>();
        }
