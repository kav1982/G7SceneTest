...
public class SceneBlendLitGUI : ShaderGUI
{
    ...
    private static class Styles
    {
        ...
        public static GUIContent pigmentMapText = new GUIContent("地表颜色贴图");
    }
    ...
    MaterialProperty _pigmentMap = null;
    MaterialProperty _xOffset = null;
    MaterialProperty _yOffset = null;
    //MaterialProperty _fallOffParam = null;
    //MaterialProperty _groundInfluence = null;
    ...
    public void FindProperties(MaterialProperty[] props)
    {
        ...
        //_fallOffParam = FindProperty("_FalloffParam", props);
        //_groundInfluence = FindProperty("_GroundInfluence", props);
        ...
        _pigmentMap = FindProperty("_PigmentMap", props);
        _xOffset = FindProperty("_XOffset",props);
        _yOffset = FindProperty("_YOffset",props);
    }
    ...
    public void ShaderPropertiesGUI(Material material)
    {
        ...
        //m_MaterialEditor.ShaderProperty(_groundInfluence, "地表融合强度");
        ...
        m_MaterialEditor.TexturePropertySingleLine(Styles.pigmentMapText, _pigmentMap);
        ...
        {
            EditorGUI.indentLevel++;
            m_MaterialEditor.ShaderProperty(_xOffset, "融合坐标偏移X");
            m_MaterialEditor.ShaderProperty(_yOffset, "融合坐标偏移y");
            m_MaterialEditor.ShaderProperty(_TerrainBlendHeight, "混合高度");
            m_MaterialEditor.ShaderProperty(_TerrainBlendFalloff, "衰减过度");
            _TerrainBlendParam.vectorValue = new Vector4(_TerrainBlendHeight.floatValue, _TerrainBlendFalloff.floatValue, _xOffset.floatValue, _yOffset.floatValue);
            EditorGUI.indentLevel--;
        }
    ...
    void UpdateKeyword(Material material)
    {
        ...
        material.SetKeyword("_PIGMAP_BLEND_ON", _TerrainBlendToggle.floatValue != 0);
