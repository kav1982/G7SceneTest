#ifndef BIOUM_COMMON_PRE_PASS_INCLUDED
#define BIOUM_COMMON_PRE_PASS_INCLUDED
...
Varyings PrePassVert(Attributes input)
{
...
half4 PrePassFrag(Varyings input) : SV_TARGET
{
