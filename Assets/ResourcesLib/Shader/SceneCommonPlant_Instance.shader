Shader "Bioum/Scene/CommonPlant_GPUInstance"
{
    Properties
    {
    ...
    HLSLINCLUDE
        #include "SceneCommonPlantInput_Instance.hlsl"
    ENDHLSL
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "SceneCommonPlantPass_Instance.hlsl"
            ENDHLSL
        }
        Pass
        {
    ...
    CustomEditor "SceneCommonPlant_InstanceGUI"
}
