...
UNITY_DEFINE_INSTANCED_PROP(half4, _EdgeParam)
...
#define Prop_EdgeMaskScale UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial, _EdgeParam).x
#define Prop_EdgeThred UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial, _EdgeParam).y
#define Prop_EdgePow UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial, _EdgeParam).z
#define Prop_EdgeAngle UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial, _EdgeParam).w
#define Prop_EdgeAngleScale UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial, _TerrainBlendParam).z
#define Prop_EdgeColor UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial, _EdgeColor)
